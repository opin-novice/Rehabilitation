...
\begin{itemize}
    \item Sensor-adversarial or invariance-based training that goes beyond the single-source DANN, CORAL, and SWAD baselines tested here (Section~\ref{sec:robustness-c}) --- for example adversarial objectives trained across many sensors simultaneously.
