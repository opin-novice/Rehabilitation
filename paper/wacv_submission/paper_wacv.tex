...
point-cloud baseline is the most node-robust, a hand-crafted-invariant
control is the most accurate, the cheapest and exactly invariant yet collapses under sensor-node failure, and a lighter
...
1    & $6.53 / 5.00$ & $+1.54\ (23.5\%)$ & $-0.45\ [-1.60,+0.72]$ \\
...
(InvariantGRU, $6.31\pm0.16$), and the point-cloud transformer (PCT, $6.46\pm0.20$) are mutually
...
conditioning (3 seeds, both arms) changes nothing: clean $6.59\pm0.07$ vs.\ $6.46\pm0.20$, augmented
...
\midrule
PCT (baseline)              & ---     & $\mathbf{6.46\pm0.20}$ & $4.91$M & $0.60\pm0.02$ & $0.55\pm0.02$ & $-1.87\ [-2.72,-1.06]$ \\
...
retraining) closes only $\sim\!25\%$ of the gap to EGRU ($+12.05\!\to\!+10.01$~MAD; \cref{tab:nodefail},
...
\midrule
MAD lost & $+3.76$ & $+12.05$ & $+10.01$ & $\mathbf{+2.27}$ \\
\bottomrule
\end{tabular}}
\end{table}
...
that --- not any single stress --- is the claim. PCT is the most node-robust ($7.10$); InvariantGRU is
both the most accurate clean model ($6.31$) and the cheapest, at exactly zero degradation, yet collapses at
...
PCT (baseline) & $4.91$M & $6.46$ & $10.06\times$ & $7.10$\checkmark & $9.33$ \\
...
\midrule
fp64 & $5.91\times10^{-16}$ & $2.2\times10^{-14}$ & exact (theorem) \\
