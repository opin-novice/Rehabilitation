...
only a relative MAD reduction with no absolute baseline recoverable. Kuang et al.'s split is itself an
instance of the leakage \cref{tab:protocol3seed} exists to measure, so we read the field's published
numbers as a protocol artifact rather than an external accuracy ceiling to beat.
