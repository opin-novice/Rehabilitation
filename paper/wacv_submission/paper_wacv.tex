...
al.~\cite{karlov2024} report a Spearman correlation rather than MAD; Abedi et al.~\cite{abedi2023} report
...
indistinguishable from noise. A benchmark on
...
\begin{tabular}{llccc}
\toprule
Model & Group & MAD $\downarrow$ & Params & $\Delta$ vs.\ floor (95\% CI) \\
\midrule
PCT (baseline)              & ---     & $\mathbf{6.47\pm0.20}$ & $4.91$M & $-1.87\ [-2.72,-1.06]$ \\
PCT $+$ rotation aug.       & ---     & $7.47\pm0.23$ & $4.91$M & --- \\
InvariantGRU (hand-crafted) & $SO(3)$ & $\mathbf{6.31\pm0.16}$ & $0.21$M & $-2.03\ [-2.89,-1.23]$ \\
\textbf{EGRU (ours)}        & $SO(3)$ & $\mathbf{6.73\pm0.30}$ & $0.66$M & $-1.60\ [-2.37,-0.88]$ \\
\midrule
Mean-predictor floor        & ---     & $8.31\pm0.05$ & --- & --- \\
\bottomrule
\end{tabular}}
\end{table}
